...
simulation <- function(nsamp, truebeta, minnumvis, sampsize, seed){
  ...
  for (s in 1:nsamp){
    ...
    dat <- dat  %>% group_by(naccid)%>% mutate(tsl_adj = ifelse(row_number()==1,0,tsl),
    ...
    modRIRS_ar1<-lme(logimem_new ~ timesincefirst*group + timesincefirst*baseage , random=~1+timesincefirst|naccid, data=dat, correlation = corAR1() ,control = lmeControl(opt = "optim"), method="ML")
    ...
    modRI_ar1<-lme(logimem_new ~ timesincefirst*group +timesincefirst*baseage, random=~1|naccid, data=dat, correlation = corAR1() ,control = lmeControl(opt = "optim"), method="ML")
    ...
    modRIRS_UN<-lme(logimem_new ~ timesincefirst*group +timesincefirst*baseage, random=~1+timesincefirst|naccid, data=dat ,control = lmeControl(opt = "optim"), method="ML")
    ...
    modRI_UN<-lme(logimem_new ~ timesincefirst*group + timesincefirst*baseage, random=~1|naccid, data=dat, control = lmeControl(opt = "optim"), method="ML")
    ...
    #TSL
    dat <- dat[order(dat$naccid, dat$timesincefirst),]
    dat.tsl <- reshape2::dcast(dat, vnumber  ~ naccid, value.var="tsl_adj")
...
write.csv(sim.results, "test1_scuneq.csv")

#sim.results<-simulation(10, 0.5, 9, 60, 32)
#write.csv(sim.results, "test2_scuneq.csv")

sim.results<-simulation(1000, 5, 9, 60, 1213)
write.csv(sim.results, "Ns60_9vis_beta5_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, 0.5, 9, 60, 45)
write.csv(sim.results, "Ns60_9vis_beta05_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, -5, 9, 60, 12133)
write.csv(sim.results, "Ns60_9vis_betan5_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, -0.5, 9, 60, 435)
write.csv(sim.results, "Ns60_9vis_betan05_ssmc_cov_uneq.csv")



sim.results<-simulation(1000, 5, 5, 60, 1213)
write.csv(sim.results, "Ns60_5vis_beta5_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, 0.5, 5, 60, 45)
write.csv(sim.results, "Ns60_5vis_beta05_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, -5, 5, 60, 121333)
write.csv(sim.results, "Ns60_5vis_betan5_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, -0.5, 5, 60, 3435)
write.csv(sim.results, "Ns60_5vis_betan05_ssmc_cov_uneq.csv")


sim.results<-simulation(1000, 5, 3, 60, 78)
write.csv(sim.results, "Ns60_3vis_beta5_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, 0.5, 3, 60, 45)
write.csv(sim.results, "Ns60_3vis_beta05_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, -5, 3, 60, 478)
write.csv(sim.results, "Ns60_3vis_betan5_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, -0.5, 3, 60, 445)
write.csv(sim.results, "Ns60_3vis_betan05_ssmc_cov_uneq.csv")


sim.results<-simulation(1000, 5, 9, 100, 1213)
write.csv(sim.results, "Ns100_9vis_beta5_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, 0.5, 9, 100, 45)
write.csv(sim.results, "Ns100_9vis_beta05_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, -5, 9, 100, 12136)
write.csv(sim.results, "Ns100_9vis_betan5_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, -0.5, 9, 100, 456)
write.csv(sim.results, "Ns100_9vis_betan05_ssmc_cov_uneq.csv")


sim.results<-simulation(1000, 5, 5, 100, 1213)
write.csv(sim.results, "Ns100_5vis_beta5_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, 0.5, 5, 100, 45)
write.csv(sim.results, "Ns100_5vis_beta05_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, -5, 5, 100, 31213)
write.csv(sim.results, "Ns100_5vis_betan5_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, -0.5, 5, 100, 345)
write.csv(sim.results, "Ns100_5vis_betan05_ssmc_cov_uneq.csv")


sim.results<-simulation(1000, 5, 3, 100, 1213)
write.csv(sim.results, "Ns100_3vis_beta5_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, 0.5, 3, 100, 45)
write.csv(sim.results, "Ns100_3vis_beta05_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, -5, 3, 100, 1213)
write.csv(sim.results, "Ns100_3vis_betan5_ssmc_cov_uneq.csv")

sim.results<-simulation(1000, -0.5, 3, 100, 45)
write.csv(sim.results, "Ns100_3vis_betan05_ssmc_cov_uneq.csv")
