...
simulation <- function(nsamp, truebeta, minnumvis, sampsize, seed){
  ...
  for (s in 1:nsamp){
    ...
    tot.like <- 0    ## 50% of the sample size
    n <- 3000
...
sim.results<-simulation(10, -5, 9, 60, 12713)
write.csv(sim.results, "test1_cuneq.csv")

sim.results<-simulation(10, -0.5, 9, 60, 372)
write.csv(sim.results, "test2_cuneq.csv")

sim.results<-simulation(1000, -5, 9, 60, 33724)
write.csv(sim.results, "N60_9vis_beta5_cov_uneq.csv")

sim.results<-simulation(1000, -0.5, 9, 60, 475)
write.csv(sim.results, "N60_9vis_beta05_cov_uneq.csv")


sim.results<-simulation(1000, -5, 5, 60, 33724)
write.csv(sim.results, "N60_5vis_beta5_cov_uneq.csv")

sim.results<-simulation(1000, -0.5, 5, 60, 46752)
write.csv(sim.results, "N60_5vis_beta05_cov_uneq.csv")


sim.results<-simulation(1000, -5, 3, 60, 2275)
write.csv(sim.results, "N60_3vis_beta5_cov_uneq.csv")

sim.results<-simulation(1000, -0.5, 3, 60, 2572678)
write.csv(sim.results, "N60_3vis_beta05_cov_uneq.csv")



sim.results<-simulation(1000, -5, 9, 100, 125743213)
write.csv(sim.results, "N100_9vis_beta5_cov_uneq.csv")

sim.results<-simulation(1000, -0.5, 9, 100, 4547)
write.csv(sim.results, "N100_9vis_beta05_cov_uneq.csv")


sim.results<-simulation(1000, -5, 5, 100, 121373)
write.csv(sim.results, "N100_5vis_beta5_cov_uneq.csv")

sim.results<-simulation(1000, -0.5, 5, 100, 209475)
write.csv(sim.results, "N100_5vis_beta05_cov_uneq.csv")


sim.results<-simulation(1000, -5, 3, 100, 312173)
write.csv(sim.results, "N100_3vis_beta5_cov_uneq.csv")

sim.results<-simulation(1000, -0.5, 3, 100, 45755)
write.csv(sim.results, "N100_3vis_beta05_cov_uneq.csv")