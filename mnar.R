...
simulation <- function(nsamp, truebeta, minnumvis, sampsize, seed, pctmiss){
  ...
  for (s in 1:nsamp){
    tryCatch(expr = {   
      ...
      baseage<-data.frame((rnorm(length(naccid), 72.06, 9.61)))
      ...
      summary(dat.sort2$logimem_new)
      # MNAR
      prop.m = pctmiss  # 10% missingness
      mcar   = runif(N*(minnumvis-1), min=0, max=1)
      dat.sort2$y.mcar = ifelse(mcar<=prop.m & dat.sort2$logimem_new<median(dat.sort2$logimem_new) & dat.sort2$group==1, NA, dat.sort2$logimem_new)  # unrelated to anything
      ...
      modRIRS_ar1<-lme(y.mcar ~ timesincefirst*group +timesincefirst*baseage , random=~1+timesincefirst|naccid, data=dat.misss, 
                       na.action = na.exclude,  correlation = corAR1() ,control = lmeControl(opt = "optim"), method="ML")
...
write.csv(sim.results, "n1000_9vis_beta5_mnar_10.csv")

sim.results<-simulation(1000, 5, 9, 200, 24, .2)
write.csv(sim.results, "n1000_9vis_beta5_mnar_20.csv")

sim.results<-simulation(1000, 5, 9, 200, 4142, .3)
write.csv(sim.results, "n1000_9vis_beta5_mnar_30.csv")

sim.results<-simulation(1000, 5, 9, 200, 678, .4)
write.csv(sim.results, "n1000_9vis_beta5_mnar_40.csv")



sim.results<-simulation(1000, 5, 5, 200, 121683, .1)
write.csv(sim.results, "n1000_5vis_beta5_mnar_10.csv")

sim.results<-simulation(1000, 5, 5, 200, 224, .2)
write.csv(sim.results, "n1000_5vis_beta5_mnar_20.csv")

sim.results<-simulation(1000, 5, 5, 200, 40142, .3)
write.csv(sim.results, "n1000_5vis_beta5_mnar_30.csv")

sim.results<-simulation(1000, 5, 5, 200, 6078, .4)
write.csv(sim.results, "n1000_5vis_beta5_mnar_40.csv")
...
sim.results<-simulation(1000, .5, 9, 200, 12183, .1)
write.csv(sim.results, "n1000_9vis_beta05_mnar_10.csv")

sim.results<-simulation(1000, .5, 9, 200, 24, .2)
write.csv(sim.results, "n1000_9vis_beta05_mnar_20.csv")

sim.results<-simulation(1000, .5, 9, 200, 4142, .3)
write.csv(sim.results, "n1000_9vis_beta05_mnar_30.csv")

sim.results<-simulation(1000, .5, 9, 200, 678, .4)
write.csv(sim.results, "n1000_9vis_beta05_mnar_40.csv")



sim.results<-simulation(1000, .5, 5, 200, 121683, .1)
write.csv(sim.results, "n1000_5vis_beta05_mnar_10.csv")

sim.results<-simulation(1000, .5, 5, 200, 224, .2)
write.csv(sim.results, "n1000_5vis_beta05_mnar_20.csv")

sim.results<-simulation(1000, .5, 5, 200, 40142, .3)
write.csv(sim.results, "n1000_5vis_beta05_mnar_30.csv")

sim.results<-simulation(1000, .5, 5, 200, 6078, .4)
write.csv(sim.results, "n1000_5vis_beta05_mnar_40.csv")
...
write.csv(sim.results, "n1000_9vis_beta5_mnar_10_100.csv")

sim.results<-simulation(1000, 5, 9, 100, 24, .2)
write.csv(sim.results, "n1000_9vis_beta5_mnar_20_100.csv")

sim.results<-simulation(1000, 5, 9, 100, 4142, .3)
write.csv(sim.results, "n1000_9vis_beta5_mnar_30_100.csv")

sim.results<-simulation(1000, 5, 9, 100, 678, .4)
write.csv(sim.results, "n1000_9vis_beta5_mnar_40_100.csv")



sim.results<-simulation(1000, 5, 5, 100, 121683, .1)
write.csv(sim.results, "n1000_5vis_beta5_mnar_10_100.csv")

sim.results<-simulation(1000, 5, 5, 100, 224, .2)
write.csv(sim.results, "n1000_5vis_beta5_mnar_20_100.csv")

sim.results<-simulation(1000, 5, 5, 100, 40142, .3)
write.csv(sim.results, "n1000_5vis_beta5_mnar_30_100.csv")

sim.results<-simulation(1000, 5, 5, 100, 6078, .4)
write.csv(sim.results, "n1000_5vis_beta5_mnar_40_100.csv")
...
sim.results<-simulation(1000, .5, 9, 100, 12183, .1)
write.csv(sim.results, "n1000_9vis_beta05_mnar_10_100.csv")

sim.results<-simulation(1000, .5, 9, 100, 24, .2)
write.csv(sim.results, "n1000_9vis_beta05_mnar_20_100.csv")

sim.results<-simulation(1000, .5, 9, 100, 4142, .3)
write.csv(sim.results, "n1000_9vis_beta05_mnar_30_100.csv")

sim.results<-simulation(1000, .5, 9, 100, 678, .4)
write.csv(sim.results, "n1000_9vis_beta05_mnar_40_100.csv")



sim.results<-simulation(1000, .5, 5, 100, 121683, .1)
write.csv(sim.results, "n1000_5vis_beta05_mnar_10_100.csv")

sim.results<-simulation(1000, .5, 5, 100, 224, .2)
write.csv(sim.results, "n1000_5vis_beta05_mnar_20_100.csv")

sim.results<-simulation(1000, .5, 5, 100, 40142, .3)
write.csv(sim.results, "n1000_5vis_beta05_mnar_30_100.csv")

sim.results<-simulation(1000, .5, 5, 100, 6078, .4)
write.csv(sim.results, "n1000_5vis_beta05_mnar_40_100.csv")
...
write.csv(sim.results, "n1000_9vis_beta5_mnar_10_50.csv")

sim.results<-simulation(1000, 5, 9, 50, 24, .2)
write.csv(sim.results, "n1000_9vis_beta5_mnar_20_50.csv")

sim.results<-simulation(1000, 5, 9, 50, 4142, .3)
write.csv(sim.results, "n1000_9vis_beta5_mnar_30_50.csv")

sim.results<-simulation(1000, 5, 9, 50, 678, .4)
write.csv(sim.results, "n1000_9vis_beta5_mnar_40_50.csv")



sim.results<-simulation(1000, 5, 5, 50, 121683, .1)
write.csv(sim.results, "n1000_5vis_beta5_mnar_10_50.csv")

sim.results<-simulation(1000, 5, 5, 50, 224, .2)
write.csv(sim.results, "n1000_5vis_beta5_mnar_20_50.csv")

sim.results<-simulation(1000, 5, 5, 50, 40142, .3)
write.csv(sim.results, "n1000_5vis_beta5_mnar_30_50.csv")

sim.results<-simulation(1000, 5, 5, 50, 6078, .4)
write.csv(sim.results, "n1000_5vis_beta5_mnar_40_50.csv")
...
sim.results<-simulation(1000, .5, 9, 50, 12183, .1)
write.csv(sim.results, "n1000_9vis_beta05_mnar_10_50.csv")

sim.results<-simulation(1000, .5, 9, 50, 24, .2)
write.csv(sim.results, "n1000_9vis_beta05_mnar_20_50.csv")

sim.results<-simulation(1000, .5, 9, 50, 4142, .3)
write.csv(sim.results, "n1000_9vis_beta05_mnar_30_50.csv")

sim.results<-simulation(1000, .5, 9, 50, 678, .4)
write.csv(sim.results, "n1000_9vis_beta05_mnar_40_50.csv")



sim.results<-simulation(1000, .5, 5, 50, 121683, .1)
write.csv(sim.results, "n1000_5vis_beta05_mnar_10_50.csv")

sim.results<-simulation(1000, .5, 5, 50, 224, .2)
write.csv(sim.results, "n1000_5vis_beta05_mnar_20_50.csv")

sim.results<-simulation(1000, .5, 5, 50, 40142, .3)
write.csv(sim.results, "n1000_5vis_beta05_mnar_30_50.csv")

sim.results<-simulation(1000, .5, 5, 50, 6078, .4)
write.csv(sim.results, "n1000_5vis_beta05_mnar_40_50.csv")
