...
simulation <- function(nsamp, truebeta, minnumvis, sampsize, seed, pctmiss){
  ...
  for (s in 1:nsamp){
    ...
    dat$logimem_new <- (beta0 + rep(U[,1], times=p)) + (beta1 + rep(U[,2], times=p)) * dat$timesincefirst * dat$group +
      dat$timesincefirst * dat$baseage + dat$eij
    dat<-data.frame(dat)
    ...
    dat.sort2$y.mcar = ifelse(mcar<=prop.m & dat.sort2$group==1 , NA, dat.sort2$logimem_new)  # unrelated to anything
...
write.csv(sim.results, "n1000_9vis_beta5_mar_10.csv")

sim.results<-simulation(1000, 5, 9, 200, 24, .2)
write.csv(sim.results, "n1000_9vis_beta5_mar_20.csv")

sim.results<-simulation(1000, 5, 9, 200, 4142, .3)
write.csv(sim.results, "n1000_9vis_beta5_mar_30.csv")

sim.results<-simulation(1000, 5, 9, 200, 678, .4)
write.csv(sim.results, "n1000_9vis_beta5_mar_40.csv")



sim.results<-simulation(1000, 5, 5, 200, 121683, .1)
write.csv(sim.results, "n1000_5vis_beta5_mar_10.csv")

sim.results<-simulation(1000, 5, 5, 200, 224, .2)
write.csv(sim.results, "n1000_5vis_beta5_mar_20.csv")

sim.results<-simulation(1000, 5, 5, 200, 40142, .3)
write.csv(sim.results, "n1000_5vis_beta5_mar_30.csv")

sim.results<-simulation(1000, 5, 5, 200, 6078, .4)
write.csv(sim.results, "n1000_5vis_beta5_mar_40.csv")
...
sim.results<-simulation(1000, .5, 9, 200, 12183, .1)
write.csv(sim.results, "n1000_9vis_beta05_mar_10.csv")

sim.results<-simulation(1000, .5, 9, 200, 24, .2)
write.csv(sim.results, "n1000_9vis_beta05_mar_20.csv")

sim.results<-simulation(1000, .5, 9, 200, 4142, .3)
write.csv(sim.results, "n1000_9vis_beta05_mar_30.csv")

sim.results<-simulation(1000, .5, 9, 200, 678, .4)
write.csv(sim.results, "n1000_9vis_beta05_mar_40.csv")



sim.results<-simulation(1000, .5, 5, 200, 121683, .1)
write.csv(sim.results, "n1000_5vis_beta05_mar_10.csv")

sim.results<-simulation(1000, .5, 5, 200, 224, .2)
write.csv(sim.results, "n1000_5vis_beta05_mar_20.csv")

sim.results<-simulation(1000, .5, 5, 200, 40142, .3)
write.csv(sim.results, "n1000_5vis_beta05_mar_30.csv")

sim.results<-simulation(1000, .5, 5, 200, 6078, .4)
write.csv(sim.results, "n1000_5vis_beta05_mar_40.csv")
...
write.csv(sim.results, "n1000_9vis_beta5_mar_10_100.csv")

sim.results<-simulation(1000, 5, 9, 100, 24, .2)
write.csv(sim.results, "n1000_9vis_beta5_mar_20_100.csv")

sim.results<-simulation(1000, 5, 9, 100, 4142, .3)
write.csv(sim.results, "n1000_9vis_beta5_mar_30_100.csv")

sim.results<-simulation(1000, 5, 9, 100, 678, .4)
write.csv(sim.results, "n1000_9vis_beta5_mar_40_100.csv")



sim.results<-simulation(1000, 5, 5, 100, 121683, .1)
write.csv(sim.results, "n1000_5vis_beta5_mar_10_100.csv")

sim.results<-simulation(1000, 5, 5, 100, 224, .2)
write.csv(sim.results, "n1000_5vis_beta5_mar_20_100.csv")

sim.results<-simulation(1000, 5, 5, 100, 40142, .3)
write.csv(sim.results, "n1000_5vis_beta5_mar_30_100.csv")

sim.results<-simulation(1000, 5, 5, 100, 6078, .4)
write.csv(sim.results, "n1000_5vis_beta5_mar_40_100.csv")
...
sim.results<-simulation(1000, .5, 9, 100, 12183, .1)
write.csv(sim.results, "n1000_9vis_beta05_mar_10_100.csv")

sim.results<-simulation(1000, .5, 9, 100, 24, .2)
write.csv(sim.results, "n1000_9vis_beta05_mar_20_100.csv")

sim.results<-simulation(1000, .5, 9, 100, 4142, .3)
write.csv(sim.results, "n1000_9vis_beta05_mar_30_100.csv")

sim.results<-simulation(1000, .5, 9, 100, 678, .4)
write.csv(sim.results, "n1000_9vis_beta05_mar_40_100.csv")



sim.results<-simulation(1000, .5, 5, 100, 121683, .1)
write.csv(sim.results, "n1000_5vis_beta05_mar_10_100.csv")

sim.results<-simulation(1000, .5, 5, 100, 224, .2)
write.csv(sim.results, "n1000_5vis_beta05_mar_20_100.csv")

sim.results<-simulation(1000, .5, 5, 100, 40142, .3)
write.csv(sim.results, "n1000_5vis_beta05_mar_30_100.csv")

sim.results<-simulation(1000, .5, 5, 100, 6078, .4)
write.csv(sim.results, "n1000_5vis_beta05_mar_40_100.csv")
...
write.csv(sim.results, "n1000_9vis_beta5_mar_10_50.csv")

sim.results<-simulation(1000, 5, 9, 50, 24, .2)
write.csv(sim.results, "n1000_9vis_beta5_mar_20_50.csv")

sim.results<-simulation(1000, 5, 9, 50, 4142, .3)
write.csv(sim.results, "n1000_9vis_beta5_mar_30_50.csv")

sim.results<-simulation(1000, 5, 9, 50, 678, .4)
write.csv(sim.results, "n1000_9vis_beta5_mar_40_50.csv")



sim.results<-simulation(1000, 5, 5, 50, 121683, .1)
write.csv(sim.results, "n1000_5vis_beta5_mar_10_50.csv")

sim.results<-simulation(1000, 5, 5, 50, 224, .2)
write.csv(sim.results, "n1000_5vis_beta5_mar_20_50.csv")

sim.results<-simulation(1000, 5, 5, 50, 40142, .3)
write.csv(sim.results, "n1000_5vis_beta5_mar_30_50.csv")

sim.results<-simulation(1000, 5, 5, 50, 6078, .4)
write.csv(sim.results, "n1000_5vis_beta5_mar_40_50.csv")
...
sim.results<-simulation(1000, .5, 9, 50, 12183, .1)
write.csv(sim.results, "n1000_9vis_beta05_mar_10_50.csv")

sim.results<-simulation(1000, .5, 9, 50, 24, .2)
write.csv(sim.results, "n1000_9vis_beta05_mar_20_50.csv")

sim.results<-simulation(1000, .5, 9, 50, 4142, .3)
write.csv(sim.results, "n1000_9vis_beta05_mar_30_50.csv")

sim.results<-simulation(1000, .5, 9, 50, 678, .4)
write.csv(sim.results, "n1000_9vis_beta05_mar_40_50.csv")



sim.results<-simulation(1000, .5, 5, 50, 121683, .1)
write.csv(sim.results, "n1000_5vis_beta05_mar_10_50.csv")

sim.results<-simulation(1000, .5, 5, 50, 224, .2)
write.csv(sim.results, "n1000_5vis_beta05_mar_20_50.csv")

sim.results<-simulation(1000, .5, 5, 50, 40142, .3)
write.csv(sim.results, "n1000_5vis_beta05_mar_30_50.csv")

sim.results<-simulation(1000, .5, 5, 50, 6078, .4)
write.csv(sim.results, "n1000_5vis_beta05_mar_40_50.csv")
